...
class DefaultShadowRenderer implements SceneRendererBase {
  ...
  _drawChildShadow(IsoDisplayObject child) {
    ...
    pt = IsoMath.isoToScreen(Pt(b.left, b.back, 0));
    _g.moveTo(pt.x, pt.y);

    pt = IsoMath.isoToScreen(Pt(b.right, b.back, 0));
    _g.lineTo(pt.x, pt.y);

    pt = IsoMath.isoToScreen(Pt(b.right, b.front, 0));
    _g.lineTo(pt.x, pt.y);

    pt = IsoMath.isoToScreen(Pt(b.left, b.front, 0));
    _g.lineTo(pt.x, pt.y);
