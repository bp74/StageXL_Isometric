...
class IsoMath {
  ...
  static AxonometricTransformationBase _transformationObj =
      DefaultIsometricTransformation();
  static AxonometricTransformationBase get transformationObject =>
      _transformationObj;
  ...
  static set transformationObject(AxonometricTransformationBase value) {
    if (value != null) {
      ...
      _transformationObj = DefaultIsometricTransformation();
    }
  }
